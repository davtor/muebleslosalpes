...
<html lang="es">
    ...
    <head>
        ...
        var cadena = "";
        var input = $("#productosSeleccionados");
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <form class="form-horizontal" role="form" action="../EliminacionProductoServlet" method="post">
                    <br>
                    <fieldset>
                        <legend>Eliminacion de Productos</legend>
                        <input type="text" name="productosSeleccionados" id="productosSeleccionados">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 5%; text-align: center">
                                        <input type="checkbox" value="<%=producto.getIdProducto()%>" name="idProducto" onclick="f_Seleccion()">
                                    </td>
                                </tr>
                                <%
                                    }
